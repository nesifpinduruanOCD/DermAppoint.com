...
public class WelcomePanel extends JPanel {
    ...
    private void createCTASection() {
        ctaPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                RadialGradientPaint gradient = new RadialGradientPaint(
                    ...
                    getWidth() * 0.6f,
                    new float[]{0.0f, 1.0f},
                    new Color[]{new Color(255, 250, 245, 200), new Color(255, 245, 238, 150)}
                );
        ...
        ctaPanel.setBorder(BorderFactory.createEmptyBorder(30, 40, 30, 40));
        ctaPanel.setMaximumSize(new Dimension(800, 300));

        // CTA title - Very dark brown
        ctaTitleLabel = new JLabel("Ready for Healthier Skin?");
        ctaTitleLabel.setFont(FontLoader.loadCustomFont(28, Font.BOLD));
        ctaTitleLabel.setForeground(new Color(60, 40, 30)); // Deep chocolate
        ctaTitleLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

        // CTA subtitle - Dark brown
        ctaSubtitleLabel = new JLabel("Join thousands who trust us with their skin health");
        ctaSubtitleLabel.setFont(FontLoader.loadCustomFont(16, Font.PLAIN));
        ctaSubtitleLabel.setForeground(TEXT_DARK);
        ctaSubtitleLabel.setAlignmentX(Component.CENTER_ALIGNMENT);
        ctaSubtitleLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 30, 0));

        // Buttons panel
        JPanel buttonsPanel = new JPanel();
        buttonsPanel.setLayout(new FlowLayout(FlowLayout.CENTER, 20, 10));
        buttonsPanel.setOpaque(false);
        buttonsPanel.setMaximumSize(new Dimension(600, 100));

        JButton primaryButton = createCTAButton("Get Started Free", true);
        primaryButton.addActionListener(e -> mainFrame.showSignUpScreen());

        JButton secondaryButton = createCTAButton("Schedule Consultation", false);
        secondaryButton.addActionListener(e -> mainFrame.showLoginScreen());

        // Make buttons responsive
        buttonsPanel.addComponentListener(new java.awt.event.ComponentAdapter() {
            @Override
            public void componentResized(java.awt.event.ComponentEvent e) {
                int width = buttonsPanel.getWidth();
                if (width < 500) {
        ...
        ctaPanel.add(ctaTitleLabel);
        ctaPanel.add(ctaSubtitleLabel);
        ctaPanel.add(buttonsPanel);
        ctaPanel.add(Box.createRigidArea(new Dimension(0, 40)));
        ...
        centerWrapper.add(ctaPanel, gbc);
    ...
    private JButton createCTAButton(String text, boolean primary) {
        JButton button = new JButton(text) {
            @Override
            protected void paintComponent(Graphics g) {
                Graphics2D g2d = (Graphics2D) g;
                ...
                if (primary) {
                    // Primary button with leather-like texture
                    Color baseColor = DEEPER_ACCENT;
                    ...
                    // Secondary button with subtle texture
                    ...
                    // Hover effect
                        ...
                        g2d.setColor(new Color(DEEPER_ACCENT.getRed(), DEEPER_ACCENT.getGreen(),
                                DEEPER_ACCENT.getBlue(), 15));
                        g2d.fillRoundRect(0, 0, getWidth(), getHeight(), 10, 10);
                    }
                }
        ...
        button.setForeground(primary ? Color.WHITE : DEEPER_ACCENT);
        button.setBackground(primary ? DEEPER_ACCENT : Color.WHITE);
        button.setFocusPainted(false);
        button.setContentAreaFilled(false);
