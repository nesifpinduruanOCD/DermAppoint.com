...
public class MainFrame extends JFrame {
    ...
    public void showDoctorDashboard(DoctorUser doctor) {
        SwingUtilities.invokeLater(() -> {
            try {
                DoctorDashboardPanel dashboard = new DoctorDashboardPanel(this, doctor);
                contentPanel.add(dashboard, "doctor_dashboard_" + doctor.getUsername());
                cardLayout.show(contentPanel, "doctor_dashboard_" + doctor.getUsername());
                setTitle("DermAppoint - Doctor Dashboard");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this,
                    "Error loading dashboard: " + e.getMessage(),
                    "Error",
    ...
    public void logout() {
        ...
        for (Component comp : components) {
            ...
            if (name != null && (name.startsWith("patient_dashboard_") || 
                                 ...
                                 name.startsWith("doctor_dashboard_"))) {
